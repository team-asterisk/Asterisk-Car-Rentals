...
const applyTo = (app) => {
    app.use(favicon(path
        .join(__dirname, '../../static/images', 'favicon.ico')));
    ...
    app.use('/css', express
        .static(path.join(__dirname, '../../static/css/')));
    app.use('/fonts', express
        .static(path.join(__dirname, '../../static/fonts/')));
    app.use('/js', express
        .static(path.join(__dirname, '../../static/js/')));
    app.use('/images', express
        .static(path.join(__dirname, '../../static/images/')));
